...
int analog_input_val0;
int analog_input_val1;
int analog_input_val2;
int analog_input_val3;
int analog_input_val4;
int analog_input_val5;
...
void setup() {
  ...
  //  for (int i = 0; i<= 5; i++) {
  //    sb.addPublish( "analog_"+i+"_val", "range", analog_input_val+i+ );
  //  }
